...
| [`proof-log.md`](proof-log.md) | Local developer proof already performed (pinned executable, no credentials; 1.14.33 and 1.18.31) |
...
node qa/specs/opencode-cloud/local-spike-storage.mjs \
  "$(pnpm --silent exec which opencode || echo node_modules/.pnpm/opencode-darwin-arm64@1.18.31/node_modules/opencode-darwin-arm64/bin/opencode)" \
