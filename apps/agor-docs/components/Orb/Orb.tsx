...
// Vendored from ReactBits (react-bits Orb, JS+CSS variant), converted to
// TypeScript to match our Aurora vendoring. WebGL orb with a glowing rim —
// used as the feature ring's halo on the landing page.
