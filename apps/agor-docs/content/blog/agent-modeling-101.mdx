...
- **Persisted teammates.** [Agor Teammates](/guide/teammates) are the long-lived agent primitive: durable identity, memory, schedules, skills, and a branch-backed home where the agent can accumulate context over time.
