...
description: 'Fully managed Agor: bring your own API keys, pen-tested and hardened for public-internet use (mobile included), same-day security patching, tenant-scoped execution isolation, private network access to your VPC, and an audit trail your security team will accept. Built and operated by the team behind Preset Cloud.'
...
Agor is fairly open under BSL 1.1. Its Additional Use Grant permits
...
Agor itself as the Agor Offering defined in the license. It has all the
...
Cloud routes sessions and workspaces through tenant-scoped runtime, storage, home, and credential boundaries. The orchestration substrate owns that enforcement; Agor does not manufacture isolation by creating host Unix accounts.
...
Agor remains source-available under BSL 1.1. Its Additional Use Grant permits
...
The open project benefits too: production learnings at Preset feed back into Agor's core. Better security, better performance, better defaults. Everyone wins.
...
_If you're running Agor yourself and want to share your experience, we'd love to hear about it. Open a discussion or drop us a note. Your feedback shapes where this goes next._
