...
> **Update (March 2026):** This experiment has evolved into a first-class Agor feature. See [Introducing Agor Teammates](/blog/agor-assistants) for the latest, including real-world use cases and Slack integration via Gateway channels.
...
- **Zones** on the board (spatial organization, [see zones docs](/guide/boards#zones))
...
Agor's [session genealogy](/guide/sessions#why-genealogy-matters) enables true multi-agent workflows.
...
**The public repo:** [github.com/preset-io/agor-teammate](https://github.com/preset-io/agor-teammate)
...
**Join me:** [github.com/preset-io/agor-teammate](https://github.com/preset-io/agor-teammate)
...
2. **The Agor teammate template** - [github.com/preset-io/agor-teammate](https://github.com/preset-io/agor-teammate)
...
The agent loop architecture (SOUL.md, MEMORY.md, persistent identity, self-improvement) is OpenClaw's innovation. I just adapted it to run inside Agor.
...
**[Try Agor →](https://agor.live)** | **[Agor Teammate GitHub →](https://github.com/preset-io/agor-teammate)** | **[Join Agor Cloud Beta →](https://docs.google.com/forms/d/e/1FAIpQLSdXtZwQBHaLFa1LYHvOHXq9IUF_Qm3T12Hr6UZcMdEvjpm2PQ/viewform?usp=dialog)**
