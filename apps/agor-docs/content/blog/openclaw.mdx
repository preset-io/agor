...
**Execution isolation.** Agents can run inside the fail-closed local filesystem sandbox or a tenant-scoped external substrate, without Agor creating host accounts.
