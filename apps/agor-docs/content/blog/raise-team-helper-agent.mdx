...
description: 'A practical recipe for turning an Agor Teammate into a PM-style teammate that remembers context, coordinates work, reports progress, and keeps a team aligned.'
date: 2026-06-17
...
That is the shape of a good team-helper agent in Agor: a 24/7 PM-style teammate with memory, access, cadence, and enough initiative to turn messy team activity into clear next actions.

Not an omniscient robot. Not a manager replacement. A practical coordination layer.

This post is a fast recipe for raising one with [Agor Teammates](/guide/teammates), [Knowledge](/guide/knowledge), [Boards](/guide/boards), [branches](/guide/branches), [sessions](/guide/sessions), the [scheduler](/guide/scheduler), and MCP-connected tools where useful.
...
1. **Identity** — who the teammate serves and how it should behave.
...
Because Agor boards are branch-centric, each card can hold sessions, environment status, PR links, notes, and spatial meaning. The teammate can use that structure to answer questions like:
...
That feedback is valuable whether you are improving the teammate, the team process, or Agor itself.
