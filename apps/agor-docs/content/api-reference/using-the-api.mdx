...
**Using the token in the API reference:** Open the authentication section in
the request client and provide the token as a Bearer token. Requests target the
local daemon declared in the schema; credentials stay in your browser.
