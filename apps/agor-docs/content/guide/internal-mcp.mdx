...
Parsed and uploaded links keep their source-owned targets read-only. Their label and pin state remain editable after the link is persisted. File and internal links cannot be copied across ownership boundaries until their lifetime and access rules are defined.
