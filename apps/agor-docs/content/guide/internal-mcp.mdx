...
| `agor_links_promote` | Promote a visible link to a branch, session, or teammate while preserving its source owner |
| `agor_links_remove_from` | Remove a link from one context while preserving its other placements |
