...
Run `agor init` after installation. It reports which optional agentic tools are available without
installing anything on your behalf. You can repeat the check with `agor doctor`; see
[Agentic tools](/guide/extended-install#agentic-tools) for installation options.
