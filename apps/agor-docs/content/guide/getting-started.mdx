...
4. **Tools.** Keep or deselect goal-tailored suggestions, or skip. **Sign in through Catalog** opens a Catalog detail drawer inside onboarding. Review its access disclosure and explicitly Connect to start OAuth or enter a token securely. Connect prepares your resumable teammate workspace; selecting or browsing a suggestion does not. Once ready, choose **Return to onboarding**. Back, cancellation, and Skip do not delete saved connections or tool sessions.
