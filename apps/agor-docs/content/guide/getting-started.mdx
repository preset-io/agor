...
2. **Teammate.** Name your AI teammate and choose a starter template, or skip this step to create a plain board without a teammate. Continue opens an inline home screen: select a registered repository or add its URL. The public starter is a source, not your destination. See [teammate homes](/guide/teammates#choose-a-persona-then-a-home).
