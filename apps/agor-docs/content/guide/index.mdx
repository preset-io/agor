...
- **Using Agor:** [feature map](/guide/features-overview), [sessions](/guide/sessions),
  [sharing and permissions](/guide/permissions), and [MCP connections](/guide/mcp-servers).
- **Operating Agor:** [installation, security, maintenance, and upgrades](/guide/operating).
- **Developing & Reference:** [contribution workflow](/guide/development),
  [architecture](/guide/architecture), and [API reference](/api-reference).
