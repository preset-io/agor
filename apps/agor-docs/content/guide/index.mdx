...
description: Team command center for all things agentic. A shared canvas for coding agents and long-lived AI teammates, anchored on git branches, with real-time multiplayer and an MCP surface agents drive themselves.
---
