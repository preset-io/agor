...
not hidden by this change. Onboarding recommendations remain hardcoded and still
include Figma; they are not dynamically filtered by catalog visibility. Its
catalog connection is unavailable while hidden.
