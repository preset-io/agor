...
allowlisting was not confirmed. Asana, incident.io, and Datadog are not hidden by
this change. Onboarding recommendations remain hardcoded: none names these six
providers, but future recommendation changes need matching catalog curation.
