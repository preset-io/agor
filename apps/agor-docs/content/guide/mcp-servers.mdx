...
Raw app secrets are refused by MCP configuration tools: use the form, or a secure
user-environment reference. Never paste a secret into agent chat. Rotating an app
