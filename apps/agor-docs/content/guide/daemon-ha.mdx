...
| Gateway listeners                                                              | Slack, GitHub, and Shortcut supported on PostgreSQL with leases and occurrence fencing. Teams is an experimental shared queue-first route with deterministic database-fence coverage but no live provider/load-balanced certification yet. The legacy generic inbound channel-key route is not a durable HA ingress. Provider-side acknowledgement/send crash gaps remain documented at-least-once windows.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
