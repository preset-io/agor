...
**Cards** are generic entities that live on boards alongside branches. They give you spatial oversight of any workflow, not just code. A [teammate](/guide/teammates) creates and manages cards via MCP tools, and you see the work unfold on the board in real time.
...
A teammate manages cards through Agor's [MCP tools](/guide/internal-mcp). The typical flow:
...
Cards do not trigger automation or spawn sessions. The teammate manages the workflow; cards show you what is happening.
...
- [Agor MCP Server](/guide/internal-mcp) (the MCP tools teammates use)
