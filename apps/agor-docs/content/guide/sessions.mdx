...
The executing-tool label shimmers unless reduced motion is enabled; approval waits and
completed tools do not shimmer. Response loading remains visible without a standalone task spinner.
