...
Messages over 2,000 source characters are eligible for collapse, regardless of
newlines or screen width. The preview targets 1,200 characters, preferring a newline
within the next 200 characters, then whitespace in that same window; otherwise it
cuts at the target. Streamdown handles incomplete Markdown in the preview. Partial
