...
one task’s full messages and restores tool blocks in their original positions. Tool
groups start collapsed; active tasks continue receiving full live activity and approvals.
