...
- [Interrupt obsolete work with urgent information](/guide/internal-mcp#interrupt-obsolete-work-and-supply-urgent-information): Enqueue, arrange the pending queue, then stop; termination and concurrency caveats
