...
trees in a virtual, scrollable viewport. Cards cap the viewport at 400 pixels;
the teammate panel shares its available height between expanded sections and
resizes with its container. On board cards,
