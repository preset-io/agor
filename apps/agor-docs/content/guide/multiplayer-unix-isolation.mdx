...
# Exact branch-root deletion; flags and path are fixed by Agor
agor ALL=(ALL) NOPASSWD: /usr/bin/rm -rf --one-file-system --preserve-root=all -- /home/*/.agor/worktrees/*
agor ALL=(ALL) NOPASSWD: /usr/bin/rm -rf --one-file-system --preserve-root=all -- /home/*/agor/worktrees/*
...
- Reinstall the shipped sudoers file after upgrading. Strict and insulated
  branch deletion needs the exact-root `rm` rules shown above; without them,
