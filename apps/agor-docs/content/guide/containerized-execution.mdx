...
> not enabled for a delegated launcher. Ambiguous exchange or credential-write outcomes surface to
> the user and are retried by starting a new code, not by automatic side-effect replay.
