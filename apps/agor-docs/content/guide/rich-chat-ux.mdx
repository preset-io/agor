...
> **Legacy File Browser flow:** A branch's **Files** tab continues to browse branch files through its existing file service. That separate flow is retained for compatibility and does not use composer attachment materialization.
