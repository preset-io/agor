...
- Run `pnpm dev` in the daemon directory to watch core and daemon changes.
- Watch mode handles recompilation during development; you do not need a separate build after each edit.
- Run the validation commands above before submitting a contribution.
