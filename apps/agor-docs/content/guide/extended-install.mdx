...
| Gemini (Beta)  | `gemini`            | `@agor-live/gemini`   |
...
Agor supports Claude Code, Codex, Gemini, OpenCode, GitHub Copilot, and Cursor. Gemini is Beta and requires an AI Studio API key; Google-account sign-in is not supported. The [onboarding wizard](/guide/getting-started#follow-the-onboarding-wizard) handles the simple case. Paste an API key, done.
