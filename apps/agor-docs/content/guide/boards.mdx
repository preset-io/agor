...
prompt branch-home Sessions, but do not become owners. Prompting another
person's execution-home Session still requires that owner's personal-sharing
grant and the workspace opt-in.
