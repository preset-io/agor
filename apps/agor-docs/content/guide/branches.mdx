...
lineage** (`provisioning_operation: restore`) until durable `ready`. It survives a
failed attempt and subsequent retries. It does not retroactively fence historical
