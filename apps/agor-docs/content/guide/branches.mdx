...
use **Recover** on its card, `agor_branches_retry_provisioning`, or
...
a teammate intentionally, first reassign or clear all primary designations through
the existing user and board controls, then use the normal archive/delete flow.
