...
2. Add that repository through **Create → Repository** (clone its URL, or register
   an existing local clone where your installation permits it).
...
If your writable framework copy is not already registered, choose **Skip for now**
on the **Teammate** step. After finishing the wizard, add your repository and create
the teammate as described above. Skipping this step creates no teammate; skipping
only the AI step does not skip teammate creation.
