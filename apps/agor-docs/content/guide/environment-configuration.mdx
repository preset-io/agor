...
minutes; the checked-in lifecycle commands keep a bounded 20-minute provider
wait instead of reporting completion before GitHub reaches the requested state.
