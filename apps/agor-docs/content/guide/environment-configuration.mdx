...
```text
AGOR_ENVIRONMENT_RESULT={"version":1,"access_urls":[{"name":"App","url":"https://app.example.com/"},{"name":"Manager","url":"https://manager.example.com/"}],"health_url":"https://app.example.com/health","resource":{"provider":"github-codespaces","id":"opaque-provider-id","name":"example-space","manage_url":"https://github.com/codespaces/example-space"}}
```
