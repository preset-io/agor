...
description: 'Agor's rich GUI sits atop a fully-typed REST API, powerful CLI, and TypeScript client—enabling git worktree management, agent orchestration from CI/CD, and custom workflows from any app.'
date: '2025-11-16'
---
