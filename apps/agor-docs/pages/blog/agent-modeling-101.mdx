...
Some agents should be calm and precise. Some should be warm and encouraging. Some should be a little annoying because the workflow needs pressure. Some should be funny because the team will interact with them every week, and a little bit of personality makes the agent feel less like plumbing.

At Preset, we have had fun giving assistants stronger identities:

- **Saul** is legal-oriented: contracts, redlines, deal risk, and the kind of careful pushback you want around legal work.
- **Blake** helps with deal desk work.
- **Peggy** helps propose, optimize, and review ad campaigns.
...
That last example is important. Personality is useful until it gets in the way of judgment, clarity, or trust. An agent can be memorable without turning every interaction into improv.
