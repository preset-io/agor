...
**Cards** are generic entities that live on boards alongside worktrees. They give you spatial oversight of any workflow — not just code. An [assistant](/guide/assistants) creates and manages cards via MCP tools, and you see the work unfold on the board in real time.
