...
**See session activity at a glance, even in background tabs.** Your browser tab's favicon updates with colored dots to show real-time status:

<div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
  <div style={{ textAlign: 'center' }}>
    <img
      src="/screenshots/favicon-running.png"
      alt="Orange dot: agent working"
  ...
  <div style={{ textAlign: 'center' }}>
    <img
      src="/screenshots/favicon-outstanding-items.png"
      alt="Green dot: ready for prompt"
      style={{ width: '48px', height: '48px' }}
    />
...
Works across all boards—automatically tracks sessions on your current board and updates in real-time via WebSocket.
