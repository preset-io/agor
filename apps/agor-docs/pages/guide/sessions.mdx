...
Every session lives inside exactly one [branch](/guide/worktrees). Multiple sessions on the same branch share a filesystem but have independent conversations.
...
- [Branches](/guide/worktrees) — The container for sessions
