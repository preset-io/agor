...
5. **No port or namespace conflicts.** Use templated offsets or namespacing flags so multiple worktrees can run simultaneously.
...
<img src="/screenshots/environment_set_up.png" alt="Agor Worktree Environment template with templated Docker commands" style={{ width: '100%', borderRadius: '8px' }} />

```text title="Repository Environment Template"
Up Command
