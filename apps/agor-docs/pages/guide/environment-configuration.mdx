...
![Agor worktree environment template configuration showing Docker Compose commands with Handlebars templating for collision-free port management](/screenshots/environment_set_up.png)
