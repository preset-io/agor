---
title: API Proxies (CORS Bypass)
description: Configure Agor daemon HTTP proxies so artifacts can call enterprise APIs that do not expose browser-friendly CORS headers.
---
