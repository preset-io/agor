...
- **No more local environment juggling** — every worktree gets a shared, persistent dev environment.
- Sessions map to isolated **git worktrees** with running apps, auto-managed ports, and health monitoring.
