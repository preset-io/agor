---
title: One-Time Launch-Code Authentication
description: Configure external launch-code handoffs so trusted applications can authenticate users into Agor with short-lived, server-verified launch codes.
---
