...
description: Install and set up agor for AI agent orchestration in under 2 minutes. Learn how to initialize, start the daemon, and create your first session.
---
