...
That's it — keep reading to add a repo and start your first session.

> Want Docker, source builds, or to know what's optional? See [Extended Installation](/guide/extended-install).
