...
![Clone Repository Dialog](/screenshots/clone-repo.png)
...
![Create New Worktree Dialog](/screenshots/new-worktree.png)
...
![Configure Agentic Tools](/screenshots/configure-agentic-tools.png)
