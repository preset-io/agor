...
description: Agents are first-class users in Agor. The built-in MCP server gives them the same surface area you have in the UI — sessions, worktrees, boards, zones, users, environments — as structured JSON-RPC.
---
