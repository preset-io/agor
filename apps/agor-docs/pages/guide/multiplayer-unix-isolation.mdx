...
6. **Regular Audits** - Review branch ownership quarterly with `agor worktree owners audit`
...
- **Branch Owners** - Explicitly granted via `worktree_owners` table
...
- [Branches](/guide/worktrees) and [Sessions & Trees](/guide/sessions) — Core primitives
