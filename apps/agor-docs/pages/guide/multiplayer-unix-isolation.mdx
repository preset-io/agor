...
# Filesystem operations (set ownership/permissions on worktrees)
agor ALL=(ALL) NOPASSWD: /usr/bin/chown *
agor ALL=(ALL) NOPASSWD: /usr/bin/chmod *
# ... and more (see full file for details)
```
