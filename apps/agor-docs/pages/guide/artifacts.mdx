...
|---|---|---|---|
| `react`, `react-ts` | Create React App (sandpack-react v2) | `REACT_APP_` | `process.env.REACT_APP_X` |
| `vue3`, `svelte`, `solid` | Vite | `VITE_` | `import.meta.env.VITE_X` |
