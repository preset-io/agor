 ...
 * CreateDialog): standalone validity/submit per modal.
 */
...
// visibility checks (a jsdom limitation, not a product bug). Stub it out; the
// gallery's own rendering is covered by TeammateGallery.test.tsx.
vi.mock('../TeammateGallery', () => ({ TeammateGallery: () => null }));
