/**
 * RateLimitBlock - Renders rate limit and API wait events
 *
...
import { ClockCircleOutlined, RobotOutlined, WarningOutlined } from '@ant-design/icons';
...
export const RateLimitBlock: React.FC<RateLimitBlockProps> = ({ message, agentic_tool }) => {
  ...
  const block = rateLimitBlock || apiWaitBlock;
  ...
  const isWarning = status !== 'allowed';
