...
describe('BranchHeaderPill', () => {
  it('opens the reported URL and permits Stop retry only after an attempt settles', () => {
    ...
    const { rerender } = render(<BranchHeaderPill {...defaultProps} branch={running} />);
    ...
    rerender(<BranchHeaderPill {...defaultProps} branch={failed} />);
    ...
    rerender(<BranchHeaderPill {...defaultProps} branch={active} />);
