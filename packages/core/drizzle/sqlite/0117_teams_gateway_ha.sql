...
--> statement-breakpoint
CREATE INDEX "gateway_inbound_events_teams_lane_idx" ON "gateway_inbound_events" ("gateway_channel_id", "thread_id", "received_at", "id") WHERE "status" IN ('pending', 'processing');
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "teams_message_deliveries_lane_idx" ON "teams_message_deliveries" ("thread_session_map_id", "created_at", "delivery_id") WHERE "status" IN ('pending', 'processing');
--> statement-breakpoint
