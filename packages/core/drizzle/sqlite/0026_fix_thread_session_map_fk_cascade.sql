...
INSERT INTO "thread_session_map_new" SELECT * FROM "thread_session_map";

-- Drop old table
DROP TABLE "thread_session_map";

-- Rename new table to original name
ALTER TABLE "thread_session_map_new" RENAME TO "thread_session_map";

-- Recreate indexes
CREATE UNIQUE INDEX "uniq_thread_map_channel_thread" ON "thread_session_map" ("channel_id","thread_id");
CREATE INDEX "idx_thread_map_session_id" ON "thread_session_map" ("session_id");
