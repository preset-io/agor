...
ALTER TABLE "serialized_sessions" ADD CONSTRAINT "serialized_sessions_task_id_tasks_task_id_fk" FOREIGN KEY ("task_id") REFERENCES "tasks"("task_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
