...
Use portable GitHub-flavored Markdown; the Agor UI additionally renders Mermaid, math, `vega-lite` fences, and GitHub callouts, while gateways such as Slack support fewer constructs.
