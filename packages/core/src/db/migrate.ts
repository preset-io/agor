...
const OFFLINE_CUTOVER_MIGRATIONS = new Set([
  ...
  // These indexes are built with regular CREATE INDEX for SQLite/PostgreSQL
  // parity. Existing installations must stop writers while they are built;
  // fresh databases still apply them automatically below.
  '0083_transcript_hydration_keysets',
  '0086_transcript_hydration_keysets',
]);
