...
describe('user-manager', () => {
  ...
  describe('getUserBranchesDir', () => {
    it('returns branches directory path', () => {
      expect(getUserBranchesDir('alice')).toBe('/home/alice/agor/worktrees');
    });

    it('uses custom home base', () => {
      expect(getUserBranchesDir('alice', '/users')).toBe('/users/alice/agor/worktrees');
    });
  });
  ...
  describe('UnixUserCommands', () => {
    ...
    describe('setupBranchesDir', () => {
      it('returns array of directory setup commands', () => {
        const cmds = UnixUserCommands.setupBranchesDir('alice');
        expect(cmds).toEqual([
  ...
  describe('constants', () => {
    ...
    it('AGOR_BRANCHES_DIR is agor/worktrees', () => {
      expect(AGOR_BRANCHES_DIR).toBe('agor/worktrees');
    });
  });
});
