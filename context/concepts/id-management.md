...
- **Don't generate entity IDs outside the canonical ID entrypoints.** Node uses `lib/ids.ts`; browser code uses `@agor/core/ids/browser`. Tests included.
