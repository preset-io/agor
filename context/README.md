...
- [`task-runtime-desired-architecture.md`](explorations/task-runtime-desired-architecture.md) — proposed target ownership and invariants for SDK supervision, finalization, and Session reconciliation.
