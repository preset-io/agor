...
- [`task-runtime-desired-architecture.md`](explorations/task-runtime-desired-architecture.md) — proposed target contract for runtime evidence, safe release, and tenant-scoped terminal reconciliation.
